...
import { availabilityFlags, exactMarketInteger, marketDetailLoadingState, marketDetailRequestPlan, marketRequestCanCommit, marketSuggestionResults, nextOptionIndex, type MarketAvailability } from "./marketUi";
